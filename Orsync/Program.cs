...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Orsync API (Auth Enabled)", Version = "v1" });

    // Keep Swagger Authorize button visible and let users paste only the raw access token
